...
var Board = /*#__PURE__*/function () {
  ...
  _createClass(Board, [{
    ...
    value: function createBoard(size) {
      ...
      wrapper.style.width = "".concat(140 * size, "px");
      for (var i = 0; i < Math.pow(size, 2); i += 1) {
...
function GamePlay_typeof(obj) { "@babel/helpers - typeof"; return GamePlay_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, GamePlay_typeof(obj); }
...
function GamePlay_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function GamePlay_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, GamePlay_toPropertyKey(descriptor.key), descriptor); } }
function GamePlay_createClass(Constructor, protoProps, staticProps) { if (protoProps) GamePlay_defineProperties(Constructor.prototype, protoProps); if (staticProps) GamePlay_defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function GamePlay_toPropertyKey(arg) { var key = GamePlay_toPrimitive(arg, "string"); return GamePlay_typeof(key) === "symbol" ? key : String(key); }
function GamePlay_toPrimitive(input, hint) { if (GamePlay_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (GamePlay_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }

var GamePlay = /*#__PURE__*/function () {
  function GamePlay() {
    var boardSize = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 4;
    GamePlay_classCallCheck(this, GamePlay);
    this.board = new Board();
    this.boardSize = boardSize;
    this.index = null;
  }
  GamePlay_createClass(GamePlay, [{
    key: "init",
    value: function init() {
      var _this = this;
      ...
      this.stopGame.addEventListener('click', function () {
        return _this.stop();
      });
    ...
    value: function getIndex() {
      ...
      var index = null;
      do {
        index = Math.floor(Math.random() * Math.pow(this.boardSize, 2));
      } while (index === this.index);
      return index;
    }
  }, {
    key: "generateGoblin",
    value: function generateGoblin() {
      if (this.index || this.index === 0) {
        this.cells[this.index].classList.remove('active');
        this.cells[this.index].innerHTML = '';
      }
      this.index = this.getIndex();
      var currentСell = this.cells[this.index];
    ...
    value: function start() {
      ...
      this.interval = setInterval(function () {
        if (!_this2.countCheck) {
          _this2.miss += 1;
          _this2.redrawGameScore();
          _this2.checkGameOver();
        }
        _this2.generateGoblin();
      }, 1000);
    }
  }, {
    key: "stop",
    ...
    key: "redrawGameScore",
    value: function redrawGameScore() {
